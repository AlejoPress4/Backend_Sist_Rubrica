...
const rubrics_controller_1 = require("./infrastructure/controllers/rubrics.controller");
let RubricsModule = class RubricsModule {
};
exports.RubricsModule = RubricsModule;
exports.RubricsModule = RubricsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([rubrica_entity_1.Rubrica, criterio_entity_1.Criterio, escala_entity_1.Escala])],
