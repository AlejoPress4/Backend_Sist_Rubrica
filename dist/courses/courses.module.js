...
const courses_controller_1 = require("./infrastructure/controllers/courses.controller");
let CoursesModule = class CoursesModule {
};
exports.CoursesModule = CoursesModule;
exports.CoursesModule = CoursesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([grupo_entity_1.Grupo, inscripcion_entity_1.Inscripcion, semestre_entity_1.Semestre])],
